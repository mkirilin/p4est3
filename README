The `p4est3` project grows on top of `p4est` software library
as an experimental feature in order to study new algorithms,
interfaces design and technical solutions.

[![DOI](https://zenodo.org/badge/526252894.svg)](https://doi.org/10.5281/zenodo.18684770)
